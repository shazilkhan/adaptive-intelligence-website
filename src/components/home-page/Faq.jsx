    ...
    <>
      ...
      <style jsx>{`
        ...
        @media (max-width: 767px) {
          /* Remove extra padding from the Accordion Button (Question) */
          :global(.accordion-style-four .accordion-button) {
            padding-left: 0 !important;
            padding-right: 0 !important;
          }

          /* Remove extra padding from the Accordion Body (Answer) */
          :global(.accordion-style-four .accordion-body) {
            padding-left: 0 !important;
            padding-right: 0 !important;
          }
          
          /* Ensure the wrapper text inside utilizes full width */
